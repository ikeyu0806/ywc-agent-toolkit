...
정적 Code 분석과 사용 가능한 browser tooling 기반 Live UI 탐색을 결합하여 Project를 UI/UX 관점에서 점검하고, 우선순위별 Markdown report를 생성하는 Codex Skill입니다.
...
- Accessibility tree, screenshot, console, computed style 등 사용 가능한 evidence를 효율적으로 수집
...
본 Skill은 Codex 환경에서 사용 가능한 browser tooling을 활용합니다. Playwright, browser MCP, Chrome DevTools MCP, screenshot, accessibility snapshot, console inspection, computed style check 등을 상황에 맞게 사용하며, live browser 도구가 없으면 code-only review로 전환하고 제약을 기록합니다.
