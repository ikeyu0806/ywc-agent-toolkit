...
Esta Skill de Claude Code ejecuta tareas generadas por la Skill ywc-task-generator. Automatiza el ciclo de vida completo de desarrollo, desde la creación de ramas hasta la implementación, commit, creación de PR, verificación de CI, merge y sincronización local.
