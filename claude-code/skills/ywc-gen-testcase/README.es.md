...
Esta Skill de Claude Code toma un PR de GitHub, un directorio de tarea completada, o el diff de git actual y produce una **hoja de pruebas en markdown con checkboxes para dos audiencias**: la Sección A para desarrolladores (puerta previa al merge) y la Sección B para QA/Navegador (puerta previa al release). La ruta de salida predeterminada es el directorio `docs/test-case/` del proyecto.
