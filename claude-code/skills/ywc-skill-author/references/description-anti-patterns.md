...
The `description` field in skill frontmatter is the primary mechanism Claude Code uses to decide whether to activate a skill. Getting it wrong is the #1 cause of skill misfires (wrong skill activated, or right skill skipped).
