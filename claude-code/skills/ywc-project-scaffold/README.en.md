...
A Claude Code Skill that generates an appropriate project directory structure in Markdown by combining language, framework, architecture pattern, protocol, and project scale.
