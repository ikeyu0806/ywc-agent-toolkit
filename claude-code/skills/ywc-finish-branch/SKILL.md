...
```bash
python tools/claude-code/skills/ywc-finish-branch/scripts/build-pr-title.py <task-name>
...
```bash
python tools/claude-code/skills/ywc-finish-branch/scripts/build-pr-title.py <task-name> --format title
