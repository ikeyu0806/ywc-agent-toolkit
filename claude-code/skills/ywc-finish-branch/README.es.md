...
Un Skill de Claude Code que entrega una Rama de Feature a su Rama Base en una sola llamada. Cubre Mark-PR-ready, CI Wait + Bot Review Polling, Merge (PR o Local), Post-Merge Verification, Mark Task Complete y Local Branch Cleanup.
...
- Pre-autorización configurada en `.claude/settings.local.json` (ver `references/local-merge-permissions.md`)
